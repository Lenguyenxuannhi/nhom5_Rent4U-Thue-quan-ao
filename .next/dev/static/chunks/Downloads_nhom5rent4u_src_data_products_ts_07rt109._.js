...
"[project]/Downloads/nhom5rent4u/src/data/products.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const HERO_IMAGE = 'https://images.unsplash.com/photo-1737188550231-cd8a16ec614b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYXNoaW9uJTIwZWRpdG9yaWFsJTIwbHV4dXJ5JTIwY3JlYW0lMjBkcmVzcyUyMG1vZGVsfGVufDF8fHx8MTc3NTgxOTUyM3ww&ixlib=rb-4.1.0&q=80&w=1080';
const HERO_IMAGE_2 = 'https://images.unsplash.com/photo-1772714601004-23b94ae3913d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYXNoaW9uJTIwbW9kZWwlMjBiZWlnZSUyMGJhY2tncm91bmQlMjBlbGVnYW50JTIwcG9zZXxlbnwxfHx8fDE3NzU4MTk1MzZ8MA&ixlib=rb-4.1.0&q=80&w=1080';
const BOUTIQUE_IMAGE = 'https://images.unsplash.com/photo-1745806115041-8711ae239878?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYXNoaW9uJTIwYm91dGlxdWUlMjBjbG90aGluZyUyMHN0b3JlJTIwaW50ZXJpb3IlMjBtaW5pbWFsfGVufDF8fHx8MTc3NTgxOTUzMnww&ixlib=rb-4.1.0&q=80&w=1080';
const PROVIDER_AVATAR = 'https://images.unsplash.com/photo-1763987275895-72f645d0acbc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b21hbiUyMHBvcnRyYWl0JTIwZmFzaGlvbiUyMHByb2ZpbGUlMjBsaWZlc3R5bGV8ZW58MXx8fHwxNzc1ODE5NTMzfDA&ixlib=rb-4.1.0&q=80&w=1080';
const products = [
    {
        id: '1',
        ...
        description: 'Chiếc đầm dạ hội lụa đen sang trọng với đường cắt tinh tế, phù hợp cho các buổi tiệc tối, sự kiện gala và lễ tốt nghiệp. Chất liệu lụa cao cấp ôm vóc dáng hoàn hảo, tạo nên vẻ quyến rũ và thanh lịch.',
        pricePerDay: 480000,
    ...
    },
    {
        ...
        description: 'Chiếc váy hoa midi nhẹ nhàng, phù hợp cho dã ngoại, sinh nhật và các buổi chụp ảnh ngoài trời. Chất liệu voan mềm mại, tạo cảm giác thoải mái và nữ tính.',
        pricePerDay: 195000,
    ...
    },
    {
        ...
        description: 'Áo blazer trắng thanh lịch dành cho phỏng vấn, họp quan trọng và sự kiện công sở. Kiểu dáng fitted tôn dáng, phù hợp với nhiều kiểu quần và váy.',
        pricePerDay: 155000,
    ...
    },
    {
        ...
        description: 'Đầm lụa trắng tinh khiết theo phong cách minimalist, lý tưởng cho chụp ảnh cưới, pre-wedding và các buổi chụp hình nghệ thuật. Đường may tinh tế, chất lụa thượng hạng.',
        pricePerDay: 350000,
    ...
    },
    {
        ...
        description: 'Áo khoác trench coat dài cổ điển, phong cách Pháp. Phù hợp mặc mùa se lạnh, du lịch và chụp ảnh ngoài trời. Chất liệu cotton cao cấp, giữ ấm tốt.',
        pricePerDay: 220000,
    ...
    },
    {
        ...
        description: 'Túi da thật vintage cao cấp, thiết kế cổ điển trường tồn với thời gian. Phụ kiện hoàn hảo để hoàn thiện bộ trang phục dạ hội hay công sở. Phù hợp cho nhiều dịp quan trọng.',
        pricePerDay: 280000,
    ...
    },
    {
        ...
        description: 'Đầm mini phong cách Y2K sặc sỡ, hoàn hảo cho tiệc sinh nhật, bar hopping và các sự kiện vui nhộn. Thiết kế trendy, cá tính và đậm chất thế hệ Z.',
        pricePerDay: 165000,
    ...
    },
    {
        ...
        description: 'Bộ trang phục streetwear năng động, phong cách Hàn Quốc hiện đại. Phù hợp cho đi chơi phố, sự kiện âm nhạc và chụp ảnh street style.',
        pricePerDay: 185000,
    ...
    },
    {
        ...
        description: 'Đầm sequin ánh kim lấp lánh, toả sáng trong mọi buổi tiệc tối và đêm nhạc hội. Thiết kế ôm dáng, tôn lên đường cong hoàn hảo. Trở thành tâm điểm của mọi sự kiện.',
        pricePerDay: 395000,
...
const reviews = [
    {
        ...
        helpful: 24,
        images: [
            'https://images.unsplash.com/photo-1764998112626-23f005c580d7?w=200'
        ]
    },
    {
        id: 'r2',
...
//# sourceMappingURL=Downloads_nhom5rent4u_src_data_products_ts_07rt109._.js.map