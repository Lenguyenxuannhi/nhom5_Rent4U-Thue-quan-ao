...
const dbPath = path.join(__dirname, '../public/mock-db/db.json')
const db = JSON.parse(fs.readFileSync(dbPath, 'utf-8'))

// Static products (from src/data/products.ts)
const staticProducts = [
  {
    id: '1',
    name: 'Đầm Dạ Hội Lụa Đen',
    provider: 'Élégance Rental House',
    providerAvatar: 'https://images.unsplash.com/photo-1763987275895-72f645d0acbc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHdvbWFuJTIwcG9ydHJhaXQlMjBmYXNoaW9uJTIwcHJvZmlsZSUyMGxpZmVzdHlsZXxlbnwxfHx8fDE3NzU4MTk1MzN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    providerRating: 4.9,
...
const existingIds = new Set((db.products || []).map(p => String(p.id)))
...
console.log('Merged static products into db.json')
